namespace TPRandomizer
{
    ...
    {
        public static List<string> WarpableStages = new()
        {
            "South Faron Woods",
        ...
        public static List<string> timeFlowStages = new()
        {
            "South Faron Woods",
            "South Faron Woods Behind Gate",
            "South Faron Woods Coros Ledge",
        ...
        public static List<string> OrdonaMapRooms = new()
        {
            "Ordon Village",
            "Ordon Ranch",
            "Ordon Spring",
        ...
        public static List<string> FaronMapRooms = new()
        {
            "South Faron Woods",
            "South Faron Woods Behind Gate",
            "South Faron Woods Coros Ledge",
        ...
        public static List<string> EldinMapRooms = new()
        {
            "Kakariko Gorge",
            "Kakariko Gorge Cave Entrance",
            "Kakariko Gorge Behind Gate",
        ...
        public static List<string> LanayruMapRooms = new()
        {
            "Lanayru Field",
            "Lanayru Field Cave Entrance",
            "Lanayru Field Behind Boulder",
        ...
        public static List<string> SnowpeakMapRooms = new()
        {
            "Snowpeak Climb Lower",
            "Snowpeak Climb Upper",
            "Snowpeak Summit Upper",
        ...
        public static List<string> GerudoMapRooms = new()
        {
            "Gerudo Desert",
            "Gerudo Desert Cave of Ordeals Plateau",
            "Gerudo Desert Basin",
