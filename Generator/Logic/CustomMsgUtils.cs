namespace TPRandomizer
{
    ...
    {
        private static readonly Dictionary<SpotId, MsgEntryId> spotIdToEntry = new()
        {
        ...
        private static readonly Dictionary<MsgEntryId, MessageEntry> idToEntry = new()
        {
            // new MessageEntry
            // {
            ...
            { MsgEntryId.Sera_Slingshot_Bought, new(StageIDs.Ordon_Village_Interiors, 1, 0x5B5) },
            { MsgEntryId.Sera_Slingshot_Bought_2, new(StageIDs.Ordon_Village_Interiors, 1, 0x5B6) },
            {
            ...
            { MsgEntryId.Custom_Sign_Kakariko_Village, new(StageIDs.Kakariko_Village, 0, 0x1369) },
            {
            ...
            { MsgEntryId.Custom_Sign_Cave_of_Ordeals, new(StageIDs.Cave_of_Ordeals, 0, 0x1369) },
            ...
            { MsgEntryId.Custom_Sign_Arbiters_Grounds, new(StageIDs.Arbiters_Grounds, 2, 0x1369) },
            ...
            { MsgEntryId.Custom_Sign_City_in_the_Sky, new(StageIDs.City_in_the_Sky, 2, 0x1369) },
            {
