...
namespace TPRandomizer
{
    ...
    public class LogicFunctions
    {
        ...
        public static SortedDictionary<string, int> generateTrickList()
        {
            SortedDictionary<string, int> trickDict = new();
            for (int i = 0; i < listOfTricks.Count; i++)
            {
                trickDict.Add(" " + listOfTricks[i], i);
            }
            return trickDict;
        }

        public static List<string> listOfTricks =
            new()
            {
                "Underwater Goron Without Zora Armor",
                "Destroy Webs With Bombs and Ball and Chain",
                "Use Bombs + Boomerang To Destroy Rocks",
                "Grab Freestanding Items With Ball and Chain",
                "Kakariko Village Watchtower Alcove Chest as Wolf",
                "Mist Area Stump Chest as Wolf",
                ...
                "Access Forest Temple West Wing With Bombling",
                "Poe 1 Skip",
                "Ladder Freezard Cancel",
                "Arbiters Grounds Big Key with Wolf",
                "Water Toadpoli Grotto with Wolf",
                "Consider heavy Magic Armor for Logic",
                "Drop from Chandelier in Lakebed",
                "Hidden Village and Poe Without Clawshot",
                "Kakariko Village Bomb Rock Spire Heart with Epona",
                "Skip Spiders in Forest Temple",
                "Zoras Domain Box Jump",
                "City in the Sky Fan Skip",
                "Snowpeak Ruins Northeast Chandelier Chest With Backslice",
                "Reach Forest Temple Lobby with Wolf",
                "Shell Blade Grotto With Normal Bombs",
                "Eldin Lava Cave Upper Chest With Nothing",
                "Eldin Lava Cave Wolf Jump",
                ...
                "Lakebed Temple Access Central Room With Enemy LJAs",
                "Bypass Death Mountain Geysers With Shield",
                "Forest Temple Reach North Wing With Bomb Boosts",
                ...
                "Forest Temple North Tile Worm Damage Boost To Chest",
                ...
                "Climb Death Mountain Without Irons"
            };
    }
}
