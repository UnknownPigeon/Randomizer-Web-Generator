  ...
  fs.readFile(indexHtmlPath, function read(err, data) {
    if (err) {
      ...
      const startingItems = [
        ...
        [63, 'Progressive Sword', 4],
        [64, 'Boomerang'],
        [72, 'Lantern'],
        [75, 'Slingshot'],
        [74, 'Progressive Fishing Rod', 2],
        [69, 'Iron Boots'],
        [67, 'Progressive Bow', 3],
        [81, 'Bomb Bag and Bombs', 3],
        [79, 'Giant Bomb Bag'],
        [49, 'Zora Armor'],
        [68, 'Progressive Clawshot', 2],
        [144, 'Aurus Memo'],
        [145, 'Asheis Sketch'],
        [65, 'Spinner'],
        [66, 'Ball and Chain'],
        [70, 'Progressive Dominion Rod', 2],
        [96, 'Empty Bottle'],
        [48, 'Magic Armor'],
        [42, 'Ordon Shield'],
        [44, 'Hylian Shield'],
        ...
        [0x85, 'Forest Temple Small Key', 4],
        [0x86, 'Goron Mines Small Key', 3],
        [0x87, 'Lakebed Temple Small Key', 3],
        [0x88, "Arbiter's Grounds Small Key", 5],
        [0x89, 'Snowpeak Ruins Small Key', 4],
        [0x8a, 'Temple of Time Small Key', 3],
        [0x8b, 'City in the Sky Small Key'],       
        [0x8c, 'Palace of Twilight Small Key', 7],
        [0x8d, 'Hyrule Castle Small Key', 3],
        [0xf9, 'Goron Mines Key Shard', 3],
